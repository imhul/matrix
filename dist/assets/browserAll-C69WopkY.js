...
import './webworkerAll-B0q141Cc.js'
...
class q {
	...
	_attachObserver() {
		'ResizeObserver' in globalThis
			...
			: this._tickerAttached || A.shared.add(this.updateTranslation, this, Z.HIGH)
	}
	destroy() {
		;(this._observer
			? (this._observer.disconnect(), (this._observer = null))
			: this._tickerAttached && A.shared.remove(this.updateTranslation),
...
function G(a) {
	...
	var n = ne(t),
		s = {
			...
			amazon: { phone: n(E), tablet: !n(E) && n(M), device: n(E) || n(M) },
			android: {
	...
	L = class J {
		...
		_deactivate() {
			...
			if (!(!this._isActive || this._isMobileAccessibility)) {
				...
				for (const i of this._children)
					((e = i._accessibleDiv) != null &&
						e.parentNode &&
						(i._accessibleDiv.parentNode.removeChild(i._accessibleDiv), (i._accessibleDiv = null)),
		...
		_addChild(e) {
			...
			;(i
				...
				: (e.accessibleType === 'button'
						...
						: ((i = document.createElement(e.accessibleType)),
							(i.style.cssText = `
                        color: transparent;
                        pointer-events: none;
                        padding: 0;
				...
				e.accessibleTitle && e.accessibleTitle !== null
					? (i.title = e.accessibleTitle)
					: (!e.accessibleHint || e.accessibleHint === null) &&
						(i.title = `container ${e.tabIndex}`),
				e.accessibleHint &&
					e.accessibleHint !== null &&
					i.setAttribute('aria-label', e.accessibleHint),
		...
		_dispatchEvent(e, t) {
			const { container: i } = e.target,
				...
				s = Object.assign(new O(n), { target: i })
...
L.defaultOptions = { enabledByDefault: !1, debug: !1, activateOnTab: !0, deactivateOnMouseMove: !0 }
let ue = L
const pe = {
	accessible: !1,
...
Q.extension = { type: [b.WebGLPipes, b.WebGPUPipes, b.CanvasPipes], name: 'dom' }
class ve {
	constructor() {
	...
	addTickerListener() {
		this._tickerAdded ||
			!this.domElement ||
			(A.system.add(this._tickerUpdate, this, Z.INTERACTION), (this._tickerAdded = !0))
	}
...
class _e {
		...
		if (
			...
			for (let u = p.length - 1; u >= 0; u--) {
				...
				if (v) {
					...
					;((v.length > 0 || c) && (c && this._allInteractiveElements.push(e), v.push(e)),
	...
	mapPointerUp(e) {
		...
		if (o) {
			...
			if (
				(l.target === r.target && t - l.timeStamp < 200 ? ++l.clickCount : (l.clickCount = 1),
				(l.target = r.target),
				(l.timeStamp = t),
...
S.defaultEventFeatures = { move: !0, globalMove: !0, click: !0, wheel: !0 }
let ee = S
const be = {
	onclick: null,
	onmousedown: null,
