...
class rt extends Ee {
	constructor(e) {
		const { sprite: t, ...r } = e,
			...
			o = Fe.from({ vertex: tt, fragment: et, name: 'mask-filter' })
		;(super({
			...r,
			gpuProgram: i,
			glProgram: o,
...
const z = class he {
	...
	buildStart(e) {
		...
		;(t ||
			...
			t.default ||
				(t.default = new ne({ maxTextures: this.renderer.limits.maxBatchableTextures }))),
	...
	addToBatch(e, t) {
		if (this._activeBatch.name !== e.batcherName) {
			...
			;(r || ((r = this._activeBatches[e.batcherName] = he.getBatcher(e.batcherName)), r.begin()),
				(this._activeBatch = r))
		}
...
z.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'batch' }
z._availableBatchers = Object.create(null)
let fe = z
...
class pe {
	...
	execute(e) {
		...
		if (e.action === 'pushMaskBegin') {
			...
			;(r &&
				(t.type === F.WEBGL && t.renderTarget.finishRenderPass(),
				t.renderTarget.pop(),
...
pe.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'alphaMask' }
class me {
	constructor(e) {
		;((this._colorStack = []),
...
me.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'colorMask' }
class ve {
	constructor(e) {
...
ve.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'stencilMask' }
function At(a, e) {
...
function nt(a) {
	...
	for (const n in t) {
		...
		;(i.stride ?? (i.stride = r[i.buffer.uid]),
			...
			(s[i.buffer.uid] += Y(i.format).stride))
	}
}
const _ = []
_[f.NONE] = void 0
_[f.DISABLED] = { stencilWriteMask: 0, stencilReadMask: 0 }
...
class Dt {
	constructor(e) {
		;((this.rootViewPort = new w()),
			(this.viewport = new w()),
			(this.onRenderTargetChange = new Ne('onRenderTargetChange')),
	...
	renderStart({ target: e, clear: t, clearColor: r, frame: s }) {
		...
		;((this._renderTargetStack.length = 0),
			...
			(i = (n = this.adaptor).prerender) == null || i.call(n, this.rootRenderTarget))
	}
	postrender() {
		var e, t
	...
	bind(e, t = !0, r, s) {
		...
		return (
			ot(this.projectionMatrix, 0, 0, d.width / l.resolution, d.height / l.resolution, !n.isRoot),
...
be.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'customRender' }
function G(a, e) {
	...
	_executeCacheAsTexture(e) {
		if (e.textureNeedsUpdate) {
			...
			;(this._renderer.renderTarget.push(e.texture, !0, null, e.texture.frame),
				...
				G(e, this._renderer.renderPipes),
...
Te.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'renderGroup' }
function E(a, e) {
	e || (e = 0)
...
function ct(a) {
	...
	if (a.renderGroupParent) {
		...
		;(a.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform),
			(a.worldColor = oe(e.groupColor, r.worldColor)),
	...
	if (
		(s && !s.renderGroup
			? ((t |= a._updateFlags),
				...
				t & te && re(a, s, t))
			: ((t = a._updateFlags), a.relativeGroupTransform.copyFrom(r), t & te && re(a, dt, t)),
		!a.renderGroup)
	) {
		const n = a.children,
			i = n.length
...
function re(a, e, t) {
	...
	;(t & de &&
		...
		t & le && (a.globalDisplayStatus = a.localDisplayStatus & e.globalDisplayStatus),
		(a._updateFlags = 0))
}
function ht(a, e) {
...
class Ce {
	...
	_updateCachedRenderGroups(e, t) {
		...
		if ((e.invalidateMatrices(), e.isCachedAsTexture)) {
			if (e.textureNeedsUpdate) {
				...
				;((d._source.style = new $e({ scaleMode: l })),
					(e.texture = d),
					e._textureBounds || (e._textureBounds = new O()),
	...
	_updateRenderGroups(e) {
		...
		if (
			...
			e.structureDidChange ? E(e.childrenRenderablesToUpdate.list, 0) : ht(e, r),
			ye(e),
...
Ce.extension = { type: [u.WebGLSystem, u.WebGPUSystem, u.CanvasSystem], name: 'renderGroup' }
class Me {
	constructor(e) {
		this._renderer = e
	}
...
Me.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'sprite' }
const W = class Se {
	constructor() {
...
W.defaultOptions = { backgroundAlpha: 1, backgroundColor: 0, clearBeforeRender: !0 }
let pt = W
const y = {}
D.handle(
	u.BlendMode,
...
class we {
	...
	setBlendMode(e, t, r) {
		...
		;(this._isAdvanced && this._endAdvancedBlendMode(r),
			...
			e && ((this._isAdvanced = !!y[t]), this._isAdvanced && this._beginAdvancedBlendMode(e, r)))
	}
	_beginAdvancedBlendMode(e, t) {
		...
		if (!y[r]) {
			L(
				`Unable to assign BlendMode: '${r}'. You may want to include: import 'pixi.js/advanced-blend-modes'`
			)
			return
		}
...
we.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'blendMode' }
...
V.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'extract' }
V.defaultImageOptions = { format: 'png', quality: 1 }
let mt = V
class N extends m {
	static create(e) {
		return new N({ source: new T(e) })
	}
	resize(e, t, r) {
...
Re.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'textureGenerator' }
class Be {
	constructor(e) {
		;((this._stackIndex = 0),
	...
	bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: n }) {
		const i = this._renderer.renderTarget.renderTarget,
			o = this._stackIndex
				...
				: { worldTransformMatrix: new v(), worldColor: 4294967295, offset: new Ke() },
			l = {
		...
		;(this._renderer.renderPipes.uniformBatch
			...
			: ((h = this._bindGroupPool.pop() || new Ye()),
...
Be.extension = { type: [u.WebGLSystem, u.WebGPUSystem, u.CanvasSystem], name: 'globalUniforms' }
let _t = 1
class Ue {
	constructor() {
...
`,
			...
			globalThis.console && globalThis.console.log(`PixiJS ${Z} - ${a} - http://www.pixijs.com/`)
		se = !0
	}
}
class j {
...
j.extension = { type: [u.WebGLSystem, u.WebGPUSystem, u.CanvasSystem], name: 'hello', priority: -2 }
	...
	run() {
		...
		for (let i = 0; i < t.length; i++) {
			...
			const l = o.renderGroup ?? o.parentRenderGroup,
				d = ((n = l == null ? void 0 : l.instructionSet) == null ? void 0 : n.gcTick) ?? -1
			if (
				(((l == null ? void 0 : l.gcTick) ?? 0) === d && (o._lastUsed = e),
...
q.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'textureGC' }
q.defaultOptions = {
	textureGCActive: !0,
...
const K = class Ge {
	...
	init(e) {
		;((e = { ...Ge.defaultOptions, ...e }),
			e.view &&
				(Je(Xe, 'ViewSystem.view has been renamed to ViewSystem.canvas'), (e.canvas = e.view)),
...
K.extension = { type: [u.WebGLSystem, u.WebGPUSystem, u.CanvasSystem], name: 'view', priority: 0 }
K.defaultOptions = { width: 800, height: 600, autoDensity: !1, antialias: !1 }
let St = K
const Ft = [pt, Be, j, St, Ce, Mt, Re, mt, Qe, Ct, Ue],
	Lt = [we, fe, Me, Te, pe, ve, me, be]
export {
	Ot as B,
	_ as G,
	Dt as R,
